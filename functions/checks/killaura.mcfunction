...
execute @s[scores={aura_timer=1000..}] ~~~ summon pulse:killaura ~ ~4 ~3
execute @s[scores={aura_timer=1000..}] ~~~ summon pulse:killaura ~ ~4 ~2
execute @s[scores={aura_timer=1000..}] ~~~ scoreboard players set @s aura_timer 0
execute @s[scores={aura_timer=...10}] ~~~ kill @e[type=pulse:killaura]
