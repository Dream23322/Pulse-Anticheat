 ...
 */
 export function gui(message) {
    ...
    if(currentItem?.typeId === "minecraft:wooden_axe" && currentItem?.nameTag === config.customcommands.gui.gui_item_name)
        return player.tell("§r§6[§cPulse§6]§r You already have the UI item in your inventory.");
    ...
    player.tell("§r§6[§cPulse§6]§r The UI item has been added to your inventory.");
}
